...
<body>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <div id="emailHelp" class="form-text">Need tu upload a .webp image only</div>
                                        </div>
                                        <div class="mb-3">
    ...
    <!--Cards-->
        <div class="container mt-5">
            <div class="row">
                <?php
                    if($ejecutar = mysqli_query($varConexion, "SELECT * FROM vocabulary WHERE idCat= '".$consultaV."' ") ){
                        while ($row = $ejecutar -> fetch_array (MYSQLI_NUM)){
                            $e = array();
                    ?>

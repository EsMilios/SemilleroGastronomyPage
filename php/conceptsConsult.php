                ...
                ?>
                    <div class="categoria shadow-sm py-3 px-4 bg-body-tertiary ">
                        ...
                        <div class="textCategoria">
                            ...
                            <?php
                                if($ejecutar = mysqli_query($varConexion, "SELECT count(*) FROM concepts WHERE idCatCon = '".$consultaV."' " ) ){
                                    while ($row = $ejecutar -> fetch_array (MYSQLI_NUM)){
                                        $e = array();
                            ?>
...
<div class="container mt-5">
    <div class="row">
        <?php
            if ($ejecutar = mysqli_query($varConexion, "SELECT * FROM concepts WHERE idCatCon= '".$consultaV."' ")) {
                while ($row = $ejecutar->fetch_array(MYSQLI_NUM)) {
        ?>
